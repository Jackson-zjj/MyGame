...
namespace UnLua
{
    ...
    struct UNLUA_API FLuaIndex
    {
        ...
        FORCEINLINE lua_State* GetLuaState() const { return L; }
    ...
    struct UNLUA_API FLuaFunction
    {
        ...
        FLuaRetValues CallWithArrayParams(const TArray<T1>& Args1, T2&&... Args2) const;

        lua_State* GetActiveState() const;
        int32 GetFunctionRef() const { return FunctionRef; }
